...
export default function ComparePageError({
  ...
  return (
    <div className="min-h-screen bg-void flex flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="font-mono text-2xl font-bold text-white mb-3">Couldn&apos;t load this comparison</h1>
      <p className="text-slate-400 text-sm mb-8 max-w-md leading-relaxed">
        Something went wrong rendering this comparison page. Try again or see all comparisons.
      </p>
