...
- Decrypt and route per-user keys and model through generation ([#192](https://github.com/stevenfackley/StackAlchemist/issues/192))
...
- Add patch-only dependabot auto-merge guard ([#180](https://github.com/stevenfackley/StackAlchemist/issues/180))
- Wire secret-scan reusable workflow ([#196](https://github.com/stevenfackley/StackAlchemist/issues/196))
